...
let newArr = setZeros(), lineElem = 0, rowElem = 3, finalArr, storeArray = [], timer = 400, prod = -1, storeSpeed = timer, doTwice = false, randomObject = 0, keyPressed = false, score = 0, min = 120, max = 150, highScore = 0;
...
document.body.onkeydown = function(e){
    ...
    }else if(e.keyCode === 40 && !keyPressed){
        storeSpeed = timer;
        keyPressed = true;
        timer = 60;
        clearInterval(newInterval);
